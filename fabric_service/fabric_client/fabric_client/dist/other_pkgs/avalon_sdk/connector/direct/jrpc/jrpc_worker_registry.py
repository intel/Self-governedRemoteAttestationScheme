...
class JRPCWorkerRegistryImpl(WorkerRegistry):
    ...
    def worker_lookup(self, worker_type, organization_id=None,
    ...
    # s+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    def set_RPE_verified(self, worker_id, id=None):
        json_rpc_request = {
            "jsonrpc": "2.0",
            "method": "SetRPEVerified",
            "id": id,
            "params": {
                "workerId": worker_id
            }
    ...
    # s+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    def get_RPE_verified(self, worker_id, id=None):
        json_rpc_request = {
            "jsonrpc": "2.0",
            "method": "GetRPEVerified",
            "id": id,
            "params": {
                "workerId": worker_id
            }
    ...
    # s+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    def set_multi_RPE_verified(self, worker_id, id=None):
        json_rpc_request = {
            "jsonrpc": "2.0",
            "method": "SetMultiRPEVerified",
            "id": id,
            "params": {
                "workerId": worker_id
            }
    ...
    # s+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    def get_multi_RPE_verified(self, worker_id, id=None):
        json_rpc_request = {
            "jsonrpc": "2.0",
            "method": "GetMultiRPEVerified",
            "id": id,
            "params": {
                "workerId": worker_id
            }
