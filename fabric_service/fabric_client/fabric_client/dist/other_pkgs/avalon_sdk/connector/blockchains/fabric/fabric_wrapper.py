...
from dist.other_pkgs.avalon_sdk.connector.blockchains.fabric import base
from dist.other_pkgs.avalon_sdk.connector.blockchains.fabric import tx_committer
from dist.other_pkgs.avalon_sdk.connector.blockchains.fabric import event_listener
from dist.other_pkgs.avalon_sdk.connector.blockchains.fabric.chaincode_methods \
...
class FabricWrapper():
    ...
    def __init__(self, config):
        ...
        if self.__validate(config):
            ...
            peernames = base.get_net_info(
                FabricWrapper.network_config, 'organizations', self.__orgname,
                'peers')
            self.__peername = peernames[random_int % len(peernames)]
            # Get a txn committer
    ...
    def __validate(self, config):
        ...
        if config["fabric"]["fabric_network_file"] is None:
            ...
            return False
        self.__network_conf_file = config["fabric"]["fabric_network_file"]
